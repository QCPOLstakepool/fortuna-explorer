...
class TunaRepository(SqliteRepository):
    ...
    def _get_price(self):
        ada_tuna_pool_response = requests.get("https://analytics-balanced.spectrum.fi/cardano/pool/info/dd061b480daddd9a833d2477c791356be4e134a433e19df7eb18be10.TUNA_ADA_NFT?after=1658379570")
