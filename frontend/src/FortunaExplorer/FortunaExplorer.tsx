        ...
        <div className="FortunaExplorer">
            ...
            <div id="content">
                ...
                <div className="d-flex flex-column align-items-center mt-4 mb-4">
                    <div className="mb-2">Made with ❤️ by <a href="https://qcpol.stakepool.quebec" target="_blank" rel="noreferrer">QCPOLstakepool</a>. Powered by <a href="https://github.com/txpipe/oura" target="_blank" rel="noreferrer">Oura</a>.</div>
